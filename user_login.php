...
<head>
    <meta charset="UTF-8" />
    <title>Stage Manager || Stagiaire Login</title>
...
<body>
    <div class="overlay">
        <main>
            <div class="container">
                <h1 class="mb-4 text-center">Connexion Stagiaire</h1>
                <div class="row justify-content-center">
                    <div class="col-md-6 col-lg-5">
                        ...
                        <?php } ?>
                        <div class="card">
                            <div class="card-header">Stagiaire Connexion</div>
                            <div class="card-body">
                               <form method="post" action="" class="animated-form">
  <div class="form-group mb-4">
    <input type="email" id="user_email_address" name="user_email_address" class="form-input" required autocomplete="off" />
    <label for="user_email_address" class="form-label">Adresse email :</label>
  </div>
  <div class="form-group mb-4">
    <input type="password" id="user_email_password" name="user_email_password" class="form-input" required autocomplete="off" />
    <label for="user_email_password" class="form-label">Mot de passe :</label>
  </div>
  <input type="submit" value="Se connecter" class="btn btn-primary btn-submit mb-2" />
  <div class="text-center mt-2 text-muted-custom">
